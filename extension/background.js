...
// `provider` (default "anthropic") picks the run backend — "anthropic" (claude), "openai" (codex),
// or "grok" (Grok Build CLI); it scopes the side-panel model/effort dropdowns to that provider's
// /meta models. "google" is reserved/disabled.
