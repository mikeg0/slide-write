...
`/design` flow the shim adds chat history, session resume, dynamic provider model/effort selection
(Anthropic / OpenAI / **Grok (xAI)** via the host `grok` CLI headless, plus reserved Google), **Gemini "nano
